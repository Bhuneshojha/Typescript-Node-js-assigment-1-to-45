...
// The installation of Node JS  & Typescript Completed!!
...
// Task 3
// let personName: string ="Bhunesh kumar"
...
// let quote: string= "What is not recorded is not remembered,";
// let author: string = "Shaheed Benazir Bhuto";

// console.log(`${author} once said,"${quote}`);

// Task 5 famous_person
// let quote: string= "What is not recorded is not remembered,";
// let famous_person: string = "Shaheed Benazir Bhuto";
...
// let favouriteNumber: number= 108;
  
// console.log(`${favouriteNumber} is considered a Auspicious number  in Vedas.`)
 
//  Task 10   Comment!!

// author: [Raj kumar]
// date: [Tuesday , Fabruary 27 , 2024]

// task 9 printing my favourite number 108.

// let favouriteNumber: number= 108;
// describing my favourite number in a message format.
// console.log(`${favouriteNumber} is considered a Auspicious number  in Vedas.`)
